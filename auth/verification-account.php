...
$tipe = "Verifikasi Akun";
	    ...
	    if (isset($_POST['kirim_kode'])) {
	        ...
	        $mail->IsSMTP();
	        $mail->SMTPSecure = 'ssl'; 
	        $mail->Host = "mail.okepedia.my.id"; //host masing2 provider email
            $mail->SMTPDebug = 2;
            $mail->Port = 465;
            $mail->SMTPAuth = true;
            $mail->Username = "verif@okepedia.my.id"; //user email
            $mail->Password = "verif@okepedia.my.id"; //password email 
            $mail->SetFrom("verif@okepedia.my.id",""); //set email pengirim
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width:600px;'>
                    <tr>
                        <td bgcolor='#ffffff' align='left' style='padding:20px 30px 40px 30px;line-height:25px;'>
                            ...
                            <br />
                                ...
                                Silahkan salin kode di bawah dan tempelkan di kolom verifikasi Aplikasi Okepedia.
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td bgcolor='#ffffff' align='left' style='padding:0px 30px 0px 30px;line-height:25px;'>
                            <p style='color:#666666;font-size: 18px;font-weight:bold;margin:0;'>
                                Jika Anda tidak merasa melakukan pendaftaran dan verifikasi di Okepedia abaikan email ini dan jangan berikan kode verifikasi ke siapapun (termasuk pihak Okepedia)
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td bgcolor='#f4f4f4' align='left' style='padding:0px 30px 30px 30px;line-height:18px;'>
                            <p style='color:#666;font-size:14px;font-weight:bold;margin:0;text-align:center;'>
                                Anda menerima email ini karena Anda baru saja mendaftar untuk akun baru di Okepedia,<br />
                                <a href='https://okepedia.my.id/' target='_blank'
                    ...
                    <tr>
                        <td bgcolor='#f4f4f4' align='left'
                            ...
                            <p style='margin:0;text-align:center;'>
                                Made with <i class='fa fa-heart' style='color:red;'></i> by Okepedia
                            </p>
                        </td>
                    </tr>
                </table>
