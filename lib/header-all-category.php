...
?>
        ...
        <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed">
	        ...
	        <div class="kt-header-mobile__logo">
		        <a href="<?php echo $config['web']['url'] ?>">
			        <img alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/logooke.png" style="width: 100px; height: 32;"/>
		        </a>
	        </div>
	        <div class="kt-header-mobile__toolbar">
        ...
        <div class="kt-header__brand kt-grid__item" id="kt_header_brand">
	        <a class="kt-header__brand-logo" href="<?php echo $config['web']['url'] ?>">
		        <img alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/logooke.png" style="width: 100px; height: 40;" class="kt-header__brand-logo-default"/>
		        <img alt="Logo" src="<?php echo $config['web']['url'] ?>assets/media/logos/logooke.png" style="width: 100px; height: 32;" class="kt-header__brand-logo-sticky"/>
	        </a>		
        </div>
        <!-- End Brand -->
    ...
    <ul class="navbar-nav nav-justified w-100">
        <li class="nav-item">
            <a href="https://solusimedia.com/" class="nav-link text-center">
